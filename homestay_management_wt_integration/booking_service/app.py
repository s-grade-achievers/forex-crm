...
LOYALTY_SERVICE_URL = "https://api.forex-crm.local/api/wallet/"  # Added loyalty service URL
...
def use_points_for_booking(id):
    ...
    try:
        ...
        response = requests.post(f"{LOYALTY_SERVICE_URL}/wallets/{booking.user_id}/redeem", json=redeem_data)
